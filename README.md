...
### 🚀 About Me
- 🔭 I’m currently studying **Information Technology & Computer Engineering Education**.
...
**Databases & Tools:**
`MySQL` `PostgreSQL` `Git` `VS Code` `Linux`

**Networking & Hardware:**
`Network Architecture` `Routing & Switching` `Packet Tracer`
